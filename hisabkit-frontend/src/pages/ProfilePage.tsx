            ...
            <div className="grid gap-4">
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) => setProfile((p: UserProfile) => ({ ...p, fullName: e.target.value }))}
              ...
              <div className="space-y-1">
                ...
                <input
                  value={profile.email || ''}
                  onChange={(e) => setProfile((p: UserProfile) => ({ ...p, email: e.target.value }))}
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) => setProfile((p: UserProfile) => ({ ...p, mobile: e.target.value }))}
          ...
          <form onSubmit={saveTenant} className="mt-6 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-1">
                ...
                <input value={tenant.name || ''} onChange={(e) => setTenant((p: Tenant) => ({ ...p, name: e.target.value }))} placeholder="Business name" className={formInputClass} />
              </div>
              <div className="space-y-1">
                <p className={formLabelClass}>Business type</p>
                <input value={tenant.businessType || ''} onChange={(e) => setTenant((p: Tenant) => ({ ...p, businessType: e.target.value }))} placeholder="Retail, Wholesale, Services..." className={formInputClass} />
              </div>
              <div className="space-y-1">
                <p className={formLabelClass}>Owner name</p>
                <input value={tenant.ownerName || ''} onChange={(e) => setTenant((p: Tenant) => ({ ...p, ownerName: e.target.value }))} placeholder="Owner name" className={formInputClass} />
              </div>
              <div className="space-y-1">
                <p className={formLabelClass}>Business phone</p>
                <input value={tenant.businessPhone || ''} onChange={(e) => setTenant((p: Tenant) => ({ ...p, businessPhone: e.target.value }))} placeholder="+91xxxxxxxxxx" className={formInputClass} />
              </div>
              <div className="space-y-1">
                <p className={formLabelClass}>Business email</p>
                <input value={tenant.businessEmail || ''} onChange={(e) => setTenant((p: Tenant) => ({ ...p, businessEmail: e.target.value }))} placeholder="accounts@business.com" className={formInputClass} />
              </div>
              <div className="space-y-1">
                <p className={formLabelClass}>GST number</p>
                <input value={tenant.gstNumber || ''} onChange={(e) => setTenant((p: Tenant) => ({ ...p, gstNumber: e.target.value }))} placeholder="GSTIN" className={formInputClass} />
              </div>
              <div className="space-y-1 md:col-span-2">
                <p className={formLabelClass}>Logo URL</p>
                <input value={tenant.logoUrl || ''} onChange={(e) => setTenant((p: Tenant) => ({ ...p, logoUrl: e.target.value }))} placeholder="https://..." className={formInputClass} />
              </div>
              <div className="space-y-1 md:col-span-2">
                <p className={formLabelClass}>Business address</p>
                <input value={tenant.businessAddress || ''} onChange={(e) => setTenant((p: Tenant) => ({ ...p, businessAddress: e.target.value }))} placeholder="Business address" className={formInputClass} />
              </div>
              <div className="space-y-1 md:col-span-2">
                <p className={formLabelClass}>SMS template</p>
                <textarea value={tenant.smsTemplate || ''} onChange={(e) => setTenant((p: Tenant) => ({ ...p, smsTemplate: e.target.value }))} placeholder="SMS reminder template" className={`min-h-24 ${formInputClass}`} />
              </div>
              <div className="space-y-1 md:col-span-2">
                <p className={formLabelClass}>WhatsApp template</p>
                <textarea value={tenant.whatsappTemplate || ''} onChange={(e) => setTenant((p: Tenant) => ({ ...p, whatsappTemplate: e.target.value }))} placeholder="WhatsApp reminder template" className={`min-h-24 ${formInputClass}`} />
              </div>
            </div>
