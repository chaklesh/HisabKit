...
import { ArrowLeft, Building2, Database, Home, Layers, LogOut, Pencil, Plus, Trash2, Users } from 'lucide-react';
...
export const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 p-4 sm:p-6">
      <nav className="mx-auto mb-4 flex max-w-7xl flex-wrap items-center justify-between gap-3">
