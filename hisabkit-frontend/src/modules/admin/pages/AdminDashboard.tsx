  ...
  if (user?.role !== 'SUPER_ADMIN') {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-8 space-y-4">
        ...
        <p className="text-slate-500 max-w-sm">This module requires elevated supervisor privileges. Please contact your system administrator.</p>
      </div>
    );
  }
        ...
        <aside className="space-y-6">
          <div className="glass-card rounded-[2rem] p-6 border-none">
            <div className="flex items-center gap-2 mb-1 px-2">
               ...
               <p className="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-600">Enterprise Admin</p>
            </div>
            <h1 className="text-2xl font-black text-slate-900 tracking-tighter px-2 mb-6">Control Center</h1>
             ...
             <div className="flex items-center gap-4">
                <div className="px-5 py-2.5 rounded-2xl bg-white border border-slate-200 shadow-sm flex items-center gap-3">
                   ...
                   <select
                     ...
                     className="text-sm font-bold bg-transparent border-none outline-none focus:ring-0 cursor-pointer min-w-[120px]"
                   >
            ...
            <CardContent className="p-8">
              ...
              {isLoading ? (
                <div className="py-20 flex flex-col items-center gap-4 text-slate-400">
                   ...
                   <p className="text-sm font-bold">Synchronizing infrastructure data...</p>
                </div>
              ) : (
