...
class ModuleCatalogControllerTest {
  ...
  @MockBean private ApplicationModuleCatalogService moduleCatalogService;

  @Test
  @WithMockUser
  void testListModules_Success() throws Exception {
    when(moduleCatalogService.listModules())
        .thenReturn(
            List.of(
    ...
    mockMvc
        .perform(get("/api/modules").contentType(MediaType.APPLICATION_JSON))
