...
import { Alert, AlertDescription } from "@hisabkit/ui/components/Alert";
        ...
        <Alert>
          ...
          <AlertDescription>
            {t(
              ...
              "Your workspace settings are synchronized across the web app, mobile (when available), and shared with your team.",
            )}
          </AlertDescription>
        </Alert>
            ...
            >
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  {t(`settings.roadmap.items.${key}_desc`, "")}
                </p>
              </div>
