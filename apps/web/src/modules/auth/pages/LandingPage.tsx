          ...
          <section className="space-y-8">
            ...
            <div className="space-y-5">
              ...
              <p className="max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
                Manage customer credits, debits, and partial payments seamlessly with full
                multi-tenant security, multilingual support, and file attachments.
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {highlights.map((item) => {
                ...
                return (
                  <div
                    key={item.title}
                    className="rounded-3xl border border-white/10 bg-white/5 p-5 shadow-2xl shadow-black/10 backdrop-blur"
                  >
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-slate-900/80 p-6 shadow-[0_30px_80px_rgba(15,23,42,0.45)] backdrop-blur">
              ...
              <div className="grid gap-4 py-6 sm:grid-cols-2">
                ...
                <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                  ...
                  <p className="mt-3 text-sm leading-6 text-slate-300">
                    Powered by TanStack Query for optimal performance and seamless data
                    synchronization.
                  </p>
                </div>
              </div>
