...
export type TabKey = "tenants" | "customers" | "transactions" | "audit";
...
export const mapTenantToForm = (tenant: Tenant): TenantFormState => ({
  ...
  adminEmail: "",
  adminMobile: "",
  attachmentQuotaMb: tenant.attachmentQuotaMb || 100,
  maxAttachmentFileSizeMb: tenant.maxAttachmentFileSizeMb || 10,
  attachmentRetentionDays: tenant.attachmentRetentionDays || 365,
});
