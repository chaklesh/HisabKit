...
import { Text, useTheme, Avatar, TextInput as PaperInput } from 'react-native-paper';
import { LinearGradient } from 'expo-linear-gradient';
import { SafeAreaView } from 'react-native-safe-area-context';
import { BookOpen, LogIn, Mail, Lock, ShieldCheck, Github, Globe, Chrome, Shield } from 'lucide-react-native';
    ...
    <View style={{ flex: 1, backgroundColor: 'white' }}>
      ...
      >
        <SafeAreaView style={styles.headerContent}>
          ...
          <Text variant="displaySmall" style={styles.brandTitle}>HisabKit</Text>
          <Text variant="bodyMedium" style={styles.tagline}>Smart Business Ledger & Khata</Text>
        </SafeAreaView>
      </LinearGradient>
        ...
        >
          <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
            <View style={styles.welcomeRow}>
              <Text variant="headlineSmall" style={styles.welcomeTitle}>Welcome Back</Text>
              <Text variant="bodyMedium" style={styles.welcomeSub}>Secure access to your business accounts</Text>
            </View>
            ...
            <View style={styles.form}>
              ...
              <TouchableOpacity style={styles.forgotBtn}>
                <Text variant="labelLarge" style={{ color: theme.colors.primary, fontWeight: '800' }}>Forgot Password?</Text>
              </TouchableOpacity>
            ...
            <View style={styles.dividerContainer}>
              ...
              <Text variant="labelSmall" style={styles.dividerText}>SECURE LOGIN</Text>
              <View style={styles.divider} />
            </View>
